...
const url = "https://api.coingecko.com/api/v3/coins/bittorrent-2/market_chart?vs_currency=inr&days=";
const currencyName = "Bittorrent";

const BittorrentGraph = () => {
...
export default BittorrentGraph;
